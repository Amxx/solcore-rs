...
trait ExecMethod<ty, callvalueCheckStatus> {
...
trait RunDispatch<ty, callvalueCheckStatus> {
...
case Bool.True {
ExecMethod.exec(method, pstatus);
}
case Bool.False {
return ();
}
...
match (selector_matches(@m)) {
case Bool.True {
ExecMethod.exec(method_m, pstatus);
}
case Bool.False {
return ();
}
...
match (selector_matches(@n)) {
case Bool.True {
ExecMethod.exec(method_n, pstatus);
}
case Bool.False {
RunDispatch.go(rest, pstatus);
}
}
}
}
...
trait MethodLevelCallvalueCheck<ty, status> {
